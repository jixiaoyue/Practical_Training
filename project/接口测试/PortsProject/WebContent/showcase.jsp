...
<body>
	<div class="container flex flex-wrap justify-between">
		<div
			...
			<ul class="menu mt-6">
				...
				<li class="menu-item"><a href="MessageList"> <img
						src="./img/shujuku.png" class="icon fas mr-5"> 批量执行
				</a></li>
				<li class="divider"></li>
	...
	<div class="right">
			...
			<form action="add" method="post">
				...
				<ul class="in">
					...
					<li><span>METHOD:</span><input type="text" name="method2"
						class="method2" /></li>
					<li>&nbsp<span class="bb">BODY:</span> <textarea name="body2"
							class="body2" rows="5" cols="40"></textarea>
					</li>
				</ul>
		...
		<div class="usecase-table">
			<h3>UseCase Show</h3>
			<form method="post" name='formm' id='formm1' action='run'>
				<table border="1px" cellspacing="0">
					...
					<c:forEach items="${cases}" var="user">
						<tr>
							...
							<td align="center"><a href='delete?id=${user.id}'><img
									src="./img/delete.png" class="icon fas mr-5">delete</a></td>
							<td align="center"><a href='run?id=${user.id}'><img
									src="./img/run.png" class="icon fas mr-5">Press to run</a></td>
							<td>
								<input type="checkbox" name='choose' value='${user.id}' class='myCheck'id="'myCheck'+${user.id}"> 
								<label for="'myCheck'+${user.id}"></label> 
								<span>选择</span>
							</td>
						</tr>
					</c:forEach>
				...
				<input type="submit" name="submit" value="批量运行" id="submit">
